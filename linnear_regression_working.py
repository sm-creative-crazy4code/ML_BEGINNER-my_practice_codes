...
diabetes_X= np.array([[1],[2],[3]]) #taking last 3 datapoints for traning

# print(diabetes_X)

# 'data', 'target', 'frame', 'DESCR', 'feature_names', 'data_filename', 'target_filename', 'data_module'
diabetes_X_train = diabetes_X #taking last 3 datapoints for traning
  #taking last 3 datapoints for traning

diabetes_X_test = diabetes_X # taking first 20 for training

diabetes_y_train = np.array([3,2,4])#taking last 3 datapoints for traning
